...
myAWSIoTShadowClient.configureCredentials(groupCA, privateKeyPath, certificatePath)
...
myAWSIoTShadowHandler = myAWSIoTShadowClient.createShadowHandlerWithName(thingName, True)
...
myAWSIoTShadowHandler.shadowDelete(customShadowCallback_Delete, 5)

loopCount = 0
while True:
    JSONPayload = '{"state":{"desired":{"property":' + str(loopCount) + '}}}'
    myAWSIoTShadowHandler.shadowUpdate(JSONPayload, customShadowCallback_Update, 5)
    loopCount += 1
    time.sleep(1)
